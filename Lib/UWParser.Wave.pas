...
type
  ...
  public
    ...
    function Read(const Buffer: Pointer; const Count: Integer): Integer;
    procedure Close;
...
function TUWWAVEFile.Read(const Buffer: Pointer; const Count: Integer): Integer;
begin
