...
function TUWAvidCaption.SaveSubtitle(const FileName: String; const FPS: Single; const Encoding: TEncoding; const Subtitles: TUWSubtitles; const FromItem: Integer = -1; const ToItem: Integer = -1): Boolean;
var
...
begin
  ...
  try
    ...
    begin
      ...
      SubFile.Add(RemoveSWTags(Subtitles.Text[i]));
      SubFile.Add('', False);
    end;
